...
class VideoCrawler:
    ...
    def get_all_video_from_lecture(self, url, start=0, end=4321):
        ...
        try:
            unit_urls = [unit.get_attribute('href') for unit in
                         ...
                         self._driver.find_elements('xpath', "//a[@class='course_card_front e-click-my-voucher']")]
    ...
    def get_video_from_url(self, url):
        ...
        try:
            self._driver.find_element(By.CLASS_NAME, 'unit_item')
        except exceptions.NoSuchElementException:
